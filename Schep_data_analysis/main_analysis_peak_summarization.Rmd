...
#saving to create output table in separate file
...
#boxplot of pattern 7 for pattern weight by cell type; helps visualize the difference in association to the pattern for monocytes
