...
matchedGenes <- ATACCoGAPS::genePatternMatch(cogapsResult = cogapsResult, generanges = BuenrostroGRanges, genome = Homo.sapiens, scoreThreshold = 0.05)
...
GOterms <- ATACCoGAPS::findGOEnrichment(cogapsResult = cogapsResult, granges = BuenrostroGRanges, genome = "hg19", scoreThreshold = 0.05)
GOterms[[7]][1:10,]

TFmotifs <- ATACCoGAPS::simpleMotifTFMatch(cogapsResult = cogapsResult, generanges = BuenrostroGRanges, organism = "Homo sapiens", genome = "hg19", scoreThreshold = 0.05)
